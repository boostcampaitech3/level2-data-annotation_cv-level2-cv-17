...
def parse_args():
    ...
    # Conventional args
    parser.add_argument('--data_dir', default='../input/data/ICDAR17_Korean') # validation data
...
def do_inference(model, ckpt_fpath, data_dir, input_size, batch_size, split='public'):
    ...
    for image_fname, bboxes in zip(image_fnames, by_sample_bboxes):
        ...
        # add img_w, img_h
        ufo_result['images'][image_fname] = dict(words=words_info, img_w=image.shape[1], img_h=image.shape[0])
